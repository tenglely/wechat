...
<body>
    ...
    <div class="main">
		<div class="container">
		   ...
		   <div class="row content">
		   	...
		   	<input type="hidden" id="pid" value="<%=p%>">
		   	<div class="col-md-9">
		   	   <div class="container" id="p1">
			   	   <table id="seetable" class="im">
			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
					...
					%>
					  <form action="${APP_PATH}/addCommentPost">
					  	 <input type="hidden" name="uid" value="<%=user.getUid()%>">
					  	 <input type="hidden" name="ctype" value="post">
					  	 <input type="hidden" name="typeid" value="<%=p%>">
	...
	<script type="text/javascript">
		...
		//增加坏赞
		$(document).on("click",".addbad",function(){
			var pid=$("#pid").val();
			$.ajax({
				url:"${APP_PATH}/addbadnum",
				data:"pid="+pid,
				type:"GET",
				success:function(result){
					$("#seetable").empty();
